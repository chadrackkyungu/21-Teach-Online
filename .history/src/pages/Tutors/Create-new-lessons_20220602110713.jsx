...
import { VscDebugBreakpointUnsupported } from 'react-icons/vs'
                ...
                <CardBody>
                  ...
                  <Row>
                    ...
                    <Col md={6}>
                      ...
                      />
                       <Tooltip describeChild title="Available will make your lesson appear to students right after you publish it" >
                        <label htmlFor="">info <VscDebugBreakpointUnsupported /> </label>
                      </Tooltip>
                    </Col>
                  </Row>
