            ...
            <Col xl={12} md={6}>
              <Card className="mini-stat bg-white text-black ">
                <CardBody>
                  ...
                  <hr />
                  <FormControlLabel control={<Switch defaultChecked  />} label="Label" color="" size="medium" onChange={getValue}  />
                  <Row> 
                    ...
                    />   
                     ...
                     <Col xl={6} md={6}>
                     <AvField type="select" name="available" label="choose when your lesson should be available" className="mb-3 p-2 bg-white input-style"   errorMessage="is required"  
                      validate={{   required: { value: true }}}>
                      <option></option>
