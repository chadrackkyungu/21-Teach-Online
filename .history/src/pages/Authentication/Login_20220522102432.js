...
const Login = props => {
  ...
  //         last_signIn:authUser.metadata.lastSignInTime, 
  //         verify: String(authUser.emailVerified),
  //         pic: authUser.photoURL ? authUser.photoURL : "https://www.nj.com/resizer/zovGSasCaR41h_yUGYHXbVTQW2A=/1280x0/smart/cloudfront-us-east-1.images.arcpublishing.com/advancelocal/SJGKVE5UNVESVCW7BBOHKQCZVE.jpg"
  //       }))
  //     }else{
  //       dispatch(logout())
  //     }
