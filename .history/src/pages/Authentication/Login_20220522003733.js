...
import { auth, register, login, logout } from '../../Database/init-firebase'
...
const Login = props => {
  ...
  useEffect(() => {
   auth.onAuthStateChanged((authUser) =>{
      if(authUser){
        dispatch(login({
          uid:authUser.uid, name:authUser.displayName, lastsignIn:authUser.metadata.lastSignInTime, pic: authUser.photoURL ? authUser.photoURL : ""
        }))
      }else{
        dispatch(logout())
      }
